 ...
 */
package pboif2.pkg10119045.latihan20.targetsaldotabungan;
 ...
 */
public class PBOIF210119045Latihan20TargetSaldoTabungan {
    ...
    public static void main(String[] args) {
        ...
        while(i < saldoTarget){
            ...
            System.out.printf("Saldo dibulan ke-" + i + "%s %n", kursIndonesia.format(saldo));
            saldoAwal = saldo;
